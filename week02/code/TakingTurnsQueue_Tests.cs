...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: -PersonQueue Sub file was enqueueing by adding to the first place in line, adjusted to add to end of list queue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: -no catching for infinite turns, added catch for person.Turns <= 0
    ...
    // Defect(s) Found: -works after previous text fix
